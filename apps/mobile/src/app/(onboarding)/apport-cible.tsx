...
/**
 * Écran 4 — l'apport cible, et la phrase d'honnêteté qui va avec.
 *
 ...
 */
export default function ApportCibleScreen() {
  ...
  return (
    <OnboardingStep
      ...
      <View style={{ alignItems: 'center', gap: theme.spacing.md }}>
        <BigNumber value={formatKcal(socleEstime.apportCibleKcal)} label="calories par jour" />
